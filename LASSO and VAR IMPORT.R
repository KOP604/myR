...
rm(analysisdata)
analysisdata <- data.frame(ID=1:50000)

# ATTN: upper and lower case. It's 'for' not 'For'
## Continuous predictors
for (i in 1:20) 
	{analysisdata[,paste0("x",i)]<-runif(50000) 
	  #note random number generator needs N
	} 


### Classification variables 
analysisdata$c1<-as.factor(floor(1.5+runif(50000)*7))
analysisdata$c3<-as.factor(floor(runif(50000)*15))
for (i in 1:50000){
...
analysisdata$y<-ytrue + 6*rnorm(50000)
